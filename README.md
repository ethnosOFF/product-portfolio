...
### 🌟 Ключевые возможности (Features)
  ...
  * **AI-Driven Парсинг (Auto-Scraping):** Автоматический сбор сырых данных из Telegram-каналов и веб-сайтов с последующим извлечением структурированной информации через OpenAI API (Llama3).
...
**Zoo Merge Tycoon** — это MVP многопользовательской игры (Roblox UGC) с социальной механикой скрещивания животных. Главной целью на этапе Soft Launch была валидация геймплейных метрик, поиск масштабируемых каналов привлечения и оптимизация Unit-экономики в условиях жесткого микро-бюджета (Bootstrapping).

### 📊 Data-Driven Маркетинг и A/B-тестирование

  * **Оптимизация креативов:** Изначальная гипотеза о необходимости сложных креативов, отражающих кор-механику, не подтвердилась. Был произведен оперативный переход на эмоциональные паттерны (Pet-visuals), что дало рост CTR на 35% и снижение стоимости привлечения (CPP) на \~30%.
  ...
  * **Оптимизация воронки:** Было принято стратегическое решение отключить мобильный трафик ради чистоты данных. Исключение нецелевой аудитории подняло конверсию Click-to-Play с 20% до 36%.
